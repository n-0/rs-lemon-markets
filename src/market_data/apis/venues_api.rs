...
/// struct for typed errors of method [`get_venues_venues_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetVenuesVenuesGetError {
...
pub async fn get_venues_venues_get(configuration: &configuration::Configuration, mic: Option<Vec<String>>, sorting: Option<crate::market_data::models::SortType>, limit: Option<i32>, page: Option<i32>, authorization: Option<&str>, jwt: Option<&str>, x_consumer_custom_id: Option<&str>) -> Result<crate::market_data::models::PageVenue, Error<GetVenuesVenuesGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/venues/", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetVenuesVenuesGetError> = serde_json::from_str(&local_var_content).ok();
