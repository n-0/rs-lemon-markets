...
/// struct for typed errors of method [`get_latest_trades_trades_latest_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLatestTradesTradesLatestGetError {
...
/// struct for typed errors of method [`get_trades_trades_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTradesTradesGetError {
    Status400(crate::market_data::models::ResponseError),
    Status422(crate::market_data::models::ResponseError),
    Status500(crate::market_data::models::ResponseError),
    UnknownValue(serde_json::Value),
...
pub async fn get_latest_trades_trades_latest_get(configuration: &configuration::Configuration, mic: Option<&str>, isin: Option<Vec<String>>, decimals: Option<bool>, epoch: Option<bool>, sorting: Option<crate::market_data::models::SortType>, limit: Option<i32>, page: Option<i32>, authorization: Option<&str>, jwt: Option<&str>, x_consumer_custom_id: Option<&str>) -> Result<crate::market_data::models::ApiEndpointsTradesPageDict, Error<GetLatestTradesTradesLatestGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/trades/latest/", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLatestTradesTradesLatestGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_trades_trades_get(configuration: &configuration::Configuration, mic: Option<&str>, isin: Option<Vec<String>>, from: Option<String>, decimals: Option<bool>, epoch: Option<bool>, sorting: Option<crate::market_data::models::SortType>, limit: Option<i32>, page: Option<i32>, authorization: Option<&str>, jwt: Option<&str>, x_consumer_custom_id: Option<&str>) -> Result<crate::market_data::models::ApiEndpointsTradesPageDict, Error<GetTradesTradesGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/trades/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTradesTradesGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
