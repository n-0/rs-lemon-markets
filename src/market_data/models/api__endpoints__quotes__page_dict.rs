...
#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ApiEndpointsQuotesPageDict {
...
impl ApiEndpointsQuotesPageDict {
    pub fn new(results: Vec<Quote>, total: i32, page: i32, pages: i32) -> ApiEndpointsQuotesPageDict {
        ApiEndpointsQuotesPageDict {
            time: None,
            results,
            previous: None,
            next: None,
