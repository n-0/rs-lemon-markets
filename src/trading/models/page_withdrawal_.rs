...
pub struct PageWithdrawal {
    ...
    pub results: Vec<crate::trading::models::Withdrawal>,
...
impl PageWithdrawal {
    pub fn new(results: Vec<crate::trading::models::Withdrawal>, total: i32, page: i32, pages: i32) -> PageWithdrawal {
        PageWithdrawal {
            time: None,
            status: None,
            mode: None,
